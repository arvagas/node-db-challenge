...
**Relational databases are databases that are stored in a table, while SQL is the language that allows developers to query a relational database.**

- [ ] Why do tables need a `primary key`?
**Each entry in a table needs to have a unique identifer.**
